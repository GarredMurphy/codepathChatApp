...
Here's a walkthrough of implemented user stories:
    ...
    This video only shows some of the user stories.  But all of them are implemented.  I just ran out of time to make another recording with all of them.

<img src='https://i.imgur.com/kQdpDQ0.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
